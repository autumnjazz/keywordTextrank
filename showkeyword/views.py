...
from showkeyword.functions.textrank import textrank_keyword
...
def count(request):
    ...
    if full_text == "":
        ...
        """
    top_words = textrank_keyword(full_text, 10)

    return render(request, 'showkeyword/count.html', {'fulltext': full_text, 'list':top_words})
